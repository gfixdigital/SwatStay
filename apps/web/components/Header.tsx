...
import { ArrowUpRight, ChevronDown, Languages, Menu, Mountain, X } from "lucide-react";
import Link from "next/link";
import { useEffect, useState } from "react";
import { usePathname } from "next/navigation";
import { LoginModal } from "./LoginModal";

const links = [["Packages", "/packages"], ["Destinations", "/#destinations"], ["How it works", "/#how-it-works"], ["About", "/#about"]] as const;
...
export function Header() {
  ...
  const isActive = (href: string) => href === "/packages" ? pathname.startsWith("/packages") : href === "/#about" ? pathname === "/" : false;
  return <>

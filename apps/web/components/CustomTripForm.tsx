...
export function CustomTripForm() {
  ...
  return <form onSubmit={(event) => { event.preventDefault(); setSent(true); }} className="grid gap-4 rounded-brand border border-border bg-white p-4 shadow-editorial sm:p-6">
